...
# Cria todas as tabelas na base de dados, caso ainda não existam, com base nos modelos importados.
...
# Instancia a aplicação FastAPI com metadados para a documentação automática.
app = FastAPI(
    title="FitAI API",
...
# Configura o CORS (Cross-Origin Resource Sharing) para permitir requisições de qualquer origem.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def read_root():
    ...
    Retorna uma mensagem de boas-vindas para verificar se a API está operacional.
